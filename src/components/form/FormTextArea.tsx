...
const FormTextArea: React.FC<FormTextAreaProps> = ({
  ...
  return (
    <div className={containerClassName}>
      ...
      <textarea
        className={`block w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-800 focus:bg-white dark:focus:bg-gray-900 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-200 outline-none sm:text-sm placeholder:text-gray-400 dark:placeholder:text-gray-500 font-medium text-gray-900 dark:text-white shadow-sm resize-none ${
          error
