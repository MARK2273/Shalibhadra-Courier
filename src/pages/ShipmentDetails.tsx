    ...
    try {
      ...
      const pdfData = {
        ...
        other: {
          ...
          finalBillingAmount: shipment.final_billing_amount ?? shipment.billing_amount ?? 0,
          paymentType: shipment.payment_type || "Cash",
          taxType: shipment.tax_type || "none",
          cgst: shipment.cgst || 0,
          sgst: shipment.sgst || 0,
          igst: shipment.igst || 0,
          taxAmount: shipment.tax_amount || 0,
          utrNumber: shipment.utr_number || "",
        },
        barcodeBase64,
        qrCodeBase64,
      };
